...
export const UI: Record<Locale, Record<string, string>> = {
  en: {
    ...
    editionsLede: `${CONTINUITY.editions} consecutive weekly Markham 360 editions since ${CONTINUITY.since}. The 2026 run is indexed here as the newsletter archive.`,
    explainersLede:
  ...
  fr: {
    ...
    editionsLede: `${CONTINUITY.editions} éditions hebdomadaires consécutives de Markham 360 depuis ${CONTINUITY.since}. La série de 2026 est conservée ici comme archive du bulletin.`,
    explainersLede:
  ...
  'zh-HK': {
    ...
    explainers: '解說短片',
    allExplainers: '所有解說',
    editionsLede: `自 ${CONTINUITY.since} 年起連續 ${CONTINUITY.editions} 期《萬錦360》。2026 年各期在此作為電子通訊存檔。`,
  ...
  'zh-CN': {
    ...
    explainers: '解说短片',
    allExplainers: '所有解说',
    editionsLede: `自 ${CONTINUITY.since} 年起连续 ${CONTINUITY.editions} 期《万锦360》。2026 年各期在此作为电子通讯存档。`,
