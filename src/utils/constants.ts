...
export const UI: Record<Locale, Record<string, string>> = {
  en: {
    ...
    upcomingEvents: 'Upcoming events in Markham',
    pastEvents: 'Past events',
    communityNews: 'Community news',
    noUpcomingEvents: 'No upcoming events listed right now.',
    register: 'Register',
    eventTime: 'Time',
  ...
  fr: {
    ...
    upcomingEvents: 'Événements à venir à Markham',
    pastEvents: 'Événements passés',
    communityNews: 'Nouvelles communautaires',
  ...
  'zh-CN': {
    ...
    alsoFiling: '同期报道',
    upcomingEvents: '万锦即将举行的活动',
    pastEvents: '过往活动',
    communityNews: '社区新闻',
    noUpcomingEvents: '目前没有即将举行的活动。',
    register: '报名',
    eventTime: '时间',
    eventLocation: '地点',
    eventPrice: '费用',
...
> = {
  en: {
    ...
    communityLede:
      'A calendar of upcoming Markham events, community news, and past gatherings: workshops, forums, food drives, and partner events across the city.',
  ...
  fr: {
    ...
    communityLede:
      'Un calendrier des événements à venir à Markham, des nouvelles communautaires et des rassemblements passés : ateliers, forums, collectes et événements partenaires.',
  ...
  'zh-HK': {
    ...
    communityLede: '萬錦即將舉行的活動日曆、社區新聞與過往聚會：工作坊、論壇、募捐及合作夥伴活動。',
  ...
  'zh-CN': {
    ...
    communityLede: '万锦即将举行的活动日历、社区新闻与过往聚会：工作坊、论坛、募捐及合作伙伴活动。',
